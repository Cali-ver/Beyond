...
//     logo: (
//       <img src="/images.jpeg" alt="IELTS logo" className="w-full h-full object-contain" />
//     )
//   },
//   { 
//     name: 'SAT', 
...
//     logo: (
//       <img src="/images.png" alt="GRE logo" className="w-full h-full object-contain" />
//     )
//   },
//   { 
//     name: 'GMAT', 
...
//     logo: (
//      <img src="/images(1).png" alt="GMAT logo" className="w-full h-full object-contain" />
//     )
//   }
// ]
...
const exams = [
  { 
    ...
    grad: 'hover:bg-gradient-to-br hover:from-red-600 hover:to-rose-800',
    logo: (
      <img src="/ielts_logo.png" alt="IELTS logo" className="w-full h-full object-contain" />
    )
  },
  { 
    name: 'SAT', 
  ...
  { 
    ...
    grad: 'hover:bg-gradient-to-br hover:from-slate-800 hover:to-zinc-900',
    logo: (
      <img src="/gre_ets_logo.png" alt="GRE logo" className="w-full h-full object-contain" />
    )
  },
  { 
    name: 'GMAT', 
    ...
    grad: 'hover:bg-gradient-to-br hover:from-emerald-700 hover:to-teal-900',
    logo: (
     <img src="/gmat_logo.png" alt="GMAT logo" className="w-full h-full object-contain" />
    )
  }
]
